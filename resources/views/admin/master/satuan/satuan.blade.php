        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="font-weight: 600;">Jenis Satuan</h1>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" data-toggle="modal" data-id="{{ $m->id }}" data-nama="{{ $m->satuan }}" class="btn btn-danger btn-xs delete" style="box-shadow: 1px 2px 3px black;"><i class="fa-solid fa-eraser"></i></a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Add Satuan</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form method="POST" enctype="multipart/form-data" action="/satuan/store">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Satuan</label>
                                    <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" value="{{ old('satuan') }}" placeholder="Satuan...">
                                    @error('satuan')
...
<script>
    $('.delete').click(function() {
        var satuanid = $(this).attr('data-id');
        var satuan = $(this).attr('data-nama');
        swal({
                title: "Yakin Nih?",
                text: "Ingin Menghapus Data Dengan Nama " + satuan + " ",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletesatuan/" + satuanid + ""
